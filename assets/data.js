...
/* ==========================================================================
   部位のマッピング（週の部位別セット数グラフで使用）
   ========================================================================== */

const MUSCLE_BY_PATTERN = {
  squat:'脚', lunge:'脚', hinge:'お尻', push_h:'胸', push_v:'肩',
  shoulder_lat:'肩', rear_delt:'背中', pull_v:'背中', pull_h:'背中',
  arms_bi:'腕', arms_tri:'腕', core:'体幹', accessory:'体幹', cardio:'有酸素',
};

// パターンからの推定が実態と合わない種目だけ個別に指定する
const MUSCLE_BY_ID = {
  hg_legcurl:'脚', hg_goodmorning:'背中', hg_deadlift:'背中',
  ac_calf:'脚', ac_abduction:'お尻', ac_clam:'お尻',
};

const MUSCLE_ORDER = ['胸', '背中', '肩', '腕', '脚', 'お尻', '体幹', '有酸素'];
